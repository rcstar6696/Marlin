...
#define STRING_CONFIG_H_AUTHOR "(rcstar6696, Sapphire Plus)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST { 12.40, 12.40 }
    #define DEFAULT_Ki_LIST {  0.65,  0.65 }
    #define DEFAULT_Kd_LIST { 59.20, 59.20 }
  #else
    // Sapphire S/Pro/Plus
    #define DEFAULT_Kp 12.40
    #define DEFAULT_Ki  0.65
    #define DEFAULT_Kd 59.20
  #endif
#endif
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.4, 79.7, 400.7, 429.5 }
